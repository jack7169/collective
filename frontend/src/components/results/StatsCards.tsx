...
export function StatsCards({ stats }: StatsCardsProps) {
  const cards = [
    ...
    {
      label: "Scanned Size",
      value: formatBytes(stats.scan_total_size ?? 0),
      icon: Database,
    ...
    },
    {
      ...
      value: formatNumber(stats.total_duplicates),
      icon: Layers,
    ...
    {
      label: "Top Groups",
      value: formatNumber(stats.top_groups_by_size?.length ?? 0),
      icon: Copy,
    ...
    {
      label: "Similar Dirs",
      value: formatNumber(stats.similar_directory_pairs),
      icon: FolderSync,
